...
PROTOBUF_NAMESPACE_OPEN
template<> ::llsf_msgs::Time* Arena::CreateMaybeMessage<::llsf_msgs::Time>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace llsf_msgs {
...
class Time PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:llsf_msgs.Time) */ {
 public:
...
inline ::PROTOBUF_NAMESPACE_ID::int64 Time::sec() const {
  // @@protoc_insertion_point(field_get:llsf_msgs.Time.sec)
...
inline void Time::set_sec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:llsf_msgs.Time.sec)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int64 Time::_internal_nsec() const {
  return nsec_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 Time::nsec() const {
  // @@protoc_insertion_point(field_get:llsf_msgs.Time.nsec)
  return _internal_nsec();
}
inline void Time::_internal_set_nsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000002u;
  nsec_ = value;
}
inline void Time::set_nsec(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _internal_set_nsec(value);
  // @@protoc_insertion_point(field_set:llsf_msgs.Time.nsec)
}
